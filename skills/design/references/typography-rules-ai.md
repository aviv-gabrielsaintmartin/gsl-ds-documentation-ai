<!-- Generated from `tokens/typography/typography-rules-ai.md` on 2026-09-24 by scripts/build-design-references.py. Never edit here: edit the source and re-run the script. -->
...
agent must not read. Values: typography-tokens.md.
