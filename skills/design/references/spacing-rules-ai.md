<!-- Generated from `tokens/spacing/spacing-rules-ai.md` on 2026-09-25 by scripts/build-design-references.py. Never edit here: edit the source and re-run the script. -->
...
spacing-tokens.md · sizing-tokens.md.
Colour: [color-rules-ai.md](color-rules-ai.md).
Type: [typography-rules-ai.md](typography-rules-ai.md)._
...
Outer margin and grid gutter must match the grid tokens
