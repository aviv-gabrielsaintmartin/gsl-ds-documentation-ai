<!-- Generated from `tokens/shadow/shadow-rules-ai.md` on 2026-09-24 by scripts/build-design-references.py. Never edit here: edit the source and re-run the script. -->
...
shadow-tokens.md.
Radius: [radius-rules-ai.md](radius-rules-ai.md).
Border: [border-width-rules-ai.md](border-width-rules-ai.md)._
...
| --- | --- | --- |
| Listing / product card | **`none`** | A border — see [border-width-rules-ai.md](border-width-rules-ai.md) |
