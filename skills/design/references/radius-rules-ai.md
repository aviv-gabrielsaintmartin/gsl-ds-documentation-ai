<!-- Generated from `tokens/radius/radius-rules-ai.md` on 2026-09-24 by scripts/build-design-references.py. Never edit here: edit the source and re-run the script. -->
...
radius-tokens.md.
Spacing: [spacing-rules-ai.md](spacing-rules-ai.md).
Shadow: [shadow-rules-ai.md](shadow-rules-ai.md).
...
size-to-radius mapping lives in Card.
