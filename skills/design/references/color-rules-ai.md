<!-- Generated from `tokens/color/color-rules-ai.md` on 2026-09-24 by scripts/build-design-references.py. Never edit here: edit the source and re-run the script. -->
...
../../components/components-index.md for the
