_What is true of `Action menu` **in Figma** and nowhere else. Layer names, quirks, and
how to work with the component in the tool._

_**This is not the usage documentation.** [`action-menu.md`](action-menu.md) describes the
...
[`action-menu.md`](action-menu.md) — this is a limit of the Figma component, not of the
component.
