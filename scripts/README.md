...
| Script | What it does |
| --- | --- |
| `check-all.py` | Runs the six standing checks and prints one verdict. Read-only unless `--write` is passed. **Start here** — its docstring also lists the four questions nothing in this repo checks |
