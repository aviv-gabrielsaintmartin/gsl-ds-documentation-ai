...
| `components/` | **63 component docs** across 61 folders — `charts/` holds three of them, plus five supporting pages that are not components. 55 folders carry a self-contained `images/`. Plus the ruleset, audit and eval                                                                                                                                |
