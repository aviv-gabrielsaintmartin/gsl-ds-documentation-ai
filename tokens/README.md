...
| [tokens-ios-map.md](tokens-ios-map.md) | Every token's name on iOS. Generated by `scripts/extract_ios_token_map.py` — don't edit it. |
| `README.md` | This file. |
...
| `extract_ios_token_map.py` | Reads the iOS design-system package and writes `tokens-ios-map.md`. `--check` reports drift without writing |
